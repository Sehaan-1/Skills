...
* **Spot pass** — a fix inside a product with an existing design system that touches one component or one region of one screen. Say `spot pass` out loud, then owe exactly this:
